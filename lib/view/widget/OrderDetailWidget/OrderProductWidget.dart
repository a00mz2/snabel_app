    ...
    return Obx(
      () => Container(
        ...
        decoration: BoxDecoration(
          border: index == controller.dataOrder['items'].length - 1
              ? null
              ...
              children: [
                Container(
                  ...
                  child: AppNetworkImage(
                    imageUrl: Applink.productImage(
                      controller.dataOrder['items'][index]['image']?.toString(),
                    ),
                    fit: BoxFit.cover,
                    width: 52,
                    height: 52,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "x${controller.dataOrder['items'][index]['quantity']}",
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    controller.dataOrder['items'][index]['name'],
                    maxLines: 2,
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "${controller.dataOrder['items'][index]['quantity']}   ${controller.packageName(index)} ",
                        style: Theme.of(context).textTheme.titleLarge!.copyWith(
